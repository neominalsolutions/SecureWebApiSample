  ...
  public class AntiForgeryGeneratorMiddleware
  {
    ...
    public async Task Invoke(HttpContext context)
    {
      ...
      if (context.Request.Method == "GET" || context.Request.Path == "/api/tokens/accessToken")
      {
        ...
        context.Response.Cookies.Append("X-XSRF-TOKEN", context.Session.GetString("X-XSRF-TOKEN"), new CookieOptions { HttpOnly = true, SameSite = SameSiteMode.Strict, Secure = true });
